...
class TorrentJob(Job):
    ...
    def run(self):
        ...
        self.jobSubprocess = subprocess.Popen(["../scripts/torrent-create.sh", f"{self.dashboard.fileSystem.basePath}/processed/{self.jobPath}", f"{self.dashboard.fileSystem.basePath}/misc/{self.jobPath}/series.torrent", self.jobAnimeID, "Auto-generated torrent for Nyan Anime."], stdin=DEVNULL, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
